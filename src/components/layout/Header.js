                ...
                <div className="header-nav-inner">
                  <ul className={
                    ...
                    <li>
                      ...
                      <Link data-scroll to="/#about" style={{'display':'flex', 'justifyContent':'flex-start', 'alignItems':'center'}} data-scroll to="/#contact" onClick={closeMenu}>
                        <span>
                          <svg className="mr-8"
                               style={{'minWidth':'16px'}}
                    ...
                    <li>
                      <Link data-scroll to="/#skills" style={{'display':'flex', 'justifyContent':'flex-start', 'alignItems':'center'}} data-scroll to="/#contact" onClick={closeMenu}>
                        <span>
                          <svg className="mr-8"
                               style={{'minWidth':'16px'}}
                               viewBox="64 64 896 896" 
                    ...
                    <li>
                      <Link data-scroll to="/#projects" style={{'display':'flex', 'justifyContent':'flex-start', 'alignItems':'center'}} data-scroll to="/#contact" onClick={closeMenu}>
                        <span>
                          <svg className="mr-8"
                                style={{'minWidth':'16px'}}
                                stroke="currentColor" 
